...
// Route::get('/product/{id}', [ProductController::class, 'show3'])->name('products.show');

Route::post('/cart/add/{productType}/{id}', [CartController::class, 'add'])->name('cart.add');
Route::delete('/cart/remove/{category_id}/{id}', [CartController::class, 'removeFromCart'])->name('cart.remove');
...
Route::get('/products', [ProductController::class, 'index'])->name('products.index');
Route::get('/products/{category}', [ProductController::class, 'categoryProducts'])->name('products.category');
