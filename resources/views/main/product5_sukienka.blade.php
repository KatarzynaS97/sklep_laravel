...
{{-- <div class="alert alert-success">
    ...
    <section class="py-5  ">
        ...
        <div class="gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center  ">
            <div class=" col mb-5 produkt1 ">
                <div class=" card h-100 mr-5 mt-4">
                    <!-- Product image-->
                    <img class="card-img-top " src={{$product->image}}  alt={{$product->name}} alt="sukienka dopasowana"/>
                </div>
            </div>
        </div>
        <div class="description_product mt-5 ">
            ...
            <form action="{{ route('cart.add', ['productType' => 'dress', 'id' => $product->id]) }}" method="POST">
                @csrf
            ...
            <div class="info_skw"> 
                ...
                <p class="opis_h1_p"> 7885468</p>
                <h6 class="opis_h1_p"> Wzrost modelki:</h6>
                <p class="opis_h1_p">172 cm</p>
            </div>
                <h5 class="opis_h1_p">Modelka ma na sobie rozmiar M</h5>
            </div>
            <div class="info_rzw">
