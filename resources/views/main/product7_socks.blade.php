...
@endif
    <section class="py-5  ">
        ...
        <div class="description_product mt-5 ">
            ...
            <form action="{{ route('cart.add', ['productType' =>$product->product_type, 'id' => $product->id]) }}" method="POST">                <input type="hidden" name="name" value="{{ $product->name }}">
