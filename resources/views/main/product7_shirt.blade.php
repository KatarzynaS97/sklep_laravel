...
@endif
    <section class="py-5  ">
        ...
        <div class="container px-4 px-lg-5 mt-5 ">
            <p class=" h1 text-center tytul_produkt">Koszula w krate</p>
        </div>
        ...
        <div class="description_product mt-5 "> 
            ...
            <form action="{{ route('cart.add', ['productType' => 'shirt', 'id' => $product->id]) }}" method="POST">
                @csrf
                <input type="hidden" name="product_type" value="shirt">
            ...
            <div class="info_skw"> 
                ...
                <p class="opis_h1_p"> 2528768</p>
                <h6 class="opis_h1_p"> Wzrost modelki:</h6>
                <p class="opis_h1_p">178cm</p>
            </div>
                <br> <h5 class="opis_h1_p">Modelka ma na sobie rozmiar M</h5> 
            </div>
            <div class="info_rzw">
