            ...
            <div class="description_product mt-5 ">
                ...
                <div class="d-block m-3">
                    ...
                    <div class="info_skw">
                        ...
                        <p class="opis_h1_p"> 185468</p>
                        <h6 class="opis_h1_p"> Wzrost modelki:</h6>
                        <p class="opis_h1_p">173 cm</p>
                    </div>
                    <h5 class="opis_h1_p">Modelka ma na sobie rozmiar S</h5>
                </div>
                <div class="info_rzw">

                    <h6 class="fs-4"><a href="{{ url('/size_tables') }}"
                            class="  text-decoration-none text-dark icon-link icon-link-hover">Tabela rozmiarów</a></h6>
                    <hr width="350px">
                    <h6 class="fs-4"><a href=" {{ url('/shopping_prices') }}"
                            class="text-decoration-none text-dark">Przesyłka i płatność</a></h6>
                    <ul class="fs-4">
                        <li class="li_color">Wysyłka w <b class="li_color_product ">48h </b></li>
                        <li class="li_color">Kup do 13 a paczkę otrzymasz jutro </li>
                    </ul>
                    <hr width="350px">
                    <h6 class="fs-4"><a href="{{ url('/exchange') }}" class="text-decoration-none text-dark">Polityka
                            wymiany i zwrotów</a></h6>
                    <ul class="fs-4">
                        <li class="li_color  ">Bezpłatna wymiana na inny rozmiar</li>
                    </ul>
                    <hr width="350px">
                </div>
            </div>
