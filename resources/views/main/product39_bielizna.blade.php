...
@endif
    <section class="py-5  ">
        ...
        <div class="gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center  ">
            <div class=" col mb-5 produkt1 ">
                <div class=" card h-100 mr-5 mt-4">
                    <!-- Product image-->{{$product->name}} alt={{$product->image}} />
                </div>
            </div>
        </div>
        <div class="description_product mt-5 "> 
            ...
            <form action="{{ route('cart.add', ['productType' => 'underwear', 'id' => $product->id]) }}" method="POST">
                @csrf
                <input type="hidden" name="product_type" value="underwear">
            ...
            <div class="d-block m-3">
                ...
                <h6>Kolor: </h6>
                <p>Kremowy, Fioletowy, Pudrowy Róż</p>
                <h6>Materiał:</h6>
                <p>Tkanina</p>
